...
<div class="main-div w-100 px-auto">
    ...
    <div class="row" style="display: flex; gap: 20px">
      <div class="col-sm-8 mx-auto pt-3">
        <div class="w-100 row">
          ...
          <div class="col-sm-6 d-flex justify-content-end" style="height:350px;">
            <!--col-sm-offset-3  -->
            <?php
            include_once './detailsImage.php';
            ?>
          </div>
          <div class="col-sm-6 mx-auto mt-3" style=" width: 500px;">
  ...
  <div class="d-flex justify-content-evenly  gap-5 my-5">
    <a class="btn btn-primary bt-sm btn-sm fw-bold " href="../index.php">Back to List</a>
    <button onclick="window.print();" id="print-btn" class="btn btn-dark fw-bold text-center "> Print</button>
  </div>
  <!-- main-div -->
</div>
