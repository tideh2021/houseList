...
<div class="wrapper w-100">
  ...
  <div style="padding-top: 10px;width: 100%; padding-left: 20px;" class="w-100 justify-content-center">

    <div class="d-flex fixed-top bg-light w-100 mb-5">
      <div class="ps-2 text-center py-1 bg-light w-75">
        <h1>House2 List Table</h1>
        <!-- <p>Add Image/Update/Details/Delete</p> -->
      </div>


      <div class=" d-flex h-25 py-4 w-25 pe-2 gap-1">
        <a class="btn btn-primary btn-lg" name="addNew_house" href="addToList/index.php">Add To List</a>
        <a class="btn-danger btn-sm me-2" name="close" href="./closebutton.php">Close</a>
      </div>

    </div>

    <div class="table-responsive-xl mt-5 w-100 justify-content-center">
